...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-4-q=ugd4p0m3bl&5dz*=y=u(k6eig-)x*6cvwz2x4#!gr40aq#')
...
db_url = urlparse(os.environ.get('DATABASE_URL', 'sqlite:///db.sqlite3'))
